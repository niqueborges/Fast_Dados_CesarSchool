# Foi realizada uma pesquisa de algumas características físicas de 5 alunos de um curso, a qual coletou os seguintes dados referentes a cada pessoa para serem analisados:
